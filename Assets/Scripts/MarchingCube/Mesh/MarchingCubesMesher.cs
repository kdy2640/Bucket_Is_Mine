...
public class MarchingCubesMesher
{
    ...
    public MarchingCubesMesher(float[,,] densities, int width, int height, float resolution, float threshold, bool isSmoothShading)
    {
    ...
    public Mesh BuildChunkMesh(Vector3Int chunkCoord, int chunkSize)
    {
        ...
        int endY = Mathf.Min(startY + chunkSize, 2 * height);
